...
class PrecomputedEmbeddingGazeModel(nn.Module):
    ...
    def forward(self, image_embeddings, gaze_masks):
        H = W = self.full_model.image_encoder.img_size
        pred_masks = []
        ious = []
        for embedding, gaze_mask in zip(image_embeddings, gaze_masks):
            sparse_embeddings, dense_embeddings = self.prompt_encoder(
                points=None,
                boxes=None,
                masks=gaze_mask,
...
MODELS = {"PrecomputedEmbeddingModel": PrecomputedEmbeddingModel,
          "Model": Model,
          "PrecomputedEmbeddingGazeModel": PrecomputedEmbeddingGazeModel,
          }
